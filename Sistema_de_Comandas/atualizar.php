...
<div class="w3-padding w3-content w3-text-grey w3-third w3-margin w3-display-middle">
    ...
    <form action="atualizarAction.php" class="w3-container" method='post'>
        ...
        <input name="txtSenha" class="w3-input w3-light-grey w3-border" value="<?php echo $_GET['senha'] ?>"> <br>
        <select name="txtTipoUsuario" value="" class="w3-input w3-light-grey w3-border"></select>
        <option value="<?php echo $_GET['tipo'] ?>" selected></option>
        <?php
