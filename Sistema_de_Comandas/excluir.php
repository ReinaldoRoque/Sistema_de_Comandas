...
<div class="w3-padding w3-content w3-text-grey w3-third w3-margin w3-display-middle">
    ...
    <form action="excluirAction.php" class="w3-container" method='post'>
        ...
        <br>
        <br>
        <a href="listar.php" class="w3-button w3-teal w3-cell w3-round-large w3-left w3-xlarge">
            <i class="fa fa-ban w3-xxlarge"></i> Cancelar</a>
        <button name="btnExcluir" class="w3-button w3-red w3-cell w3-round-large w3-right  w3-xlarge">
            <i class="w3-xxlarge fa fa-check"></i> Confirmar</button>
    </form>
</div>
