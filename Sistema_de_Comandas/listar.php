...
echo ' <div class="w3-paddingw3-content w3-half w3-display-topmiddle w3-margin"> <h1 class="w3-center w3-black w3-round-large w3-margin">Listagem de Usuário</h1> <table class="w3-table-all w3-centered"> <thead> <tr class="w3-center w3-black"> <th>ID_Usuário</th> <th>Usuário</th> <th>Senha</th> <th>Tipo</th> <th>Atualizar</th> <th>Excluir</th> </tr> <thead> ';
...
if ($resultado != null)
    foreach ($resultado as $linha) {
        ...
        echo '<td >' . $linha['fk_tipo_usuario'] . '</td>';
